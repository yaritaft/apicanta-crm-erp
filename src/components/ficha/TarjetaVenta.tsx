...
export function TarjetaVenta({ e, venta, resaltada, onPagar, onEditar, onCancelar }: {
  ...
  return (
    <div className="venta-card" data-resaltada={resaltada || undefined} id={`venta-${venta.id}`}>
      <div className="venta-card__head">
        ...
        <IconButton etiqueta="Editar la venta" onClick={onEditar}><Pencil size={15} /></IconButton>
      </div>
